...
#dmd jsonRunner -L-L../ -L-lsdc-lib

dmd jsonRunner.d -I../src -I../libd-llvm/src -I../libd-llvm/libd/src -I../libd-llvm/import ../src/sdc/sdc.d ../src/sdc/conf.d ../src/util/json.d -L-L.. -L-lsdc-lib #\
