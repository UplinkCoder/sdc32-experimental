...
unittest {
	...
	// degenerate numerator.
	testUdiv(ValueRange(125, -23), ValueRange(89351496, 458963274), ValueRange(0, 206451429461));
	testUdiv(ValueRange(221, 47), ValueRange(89351496, 458963274), ValueRange(0, 206451429461));
	testUdiv(ValueRange(-12, -23), ValueRange(89351496, 458963274), ValueRange(0, 206451429461));
}
