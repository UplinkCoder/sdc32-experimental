...
struct SymbolAnalyzer {
	...
	void analyze(FunctionDeclaration fd, Function f) {
		...
		debug {
			import std.stdio;
			import d.semantic.dpure;

			writeln("Function \"",f.toString(context),"\" is pure :", isPure(f));
		}
	}
